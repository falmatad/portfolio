                                ...
                                <div className="col-lg-6" key={index}>
                                    {isOpen && (
                                        ...
                                        <Lightbox
                                            ...
                                            toolbarButtons={TabOne[tab1].link.ios? [<a target="_blank" rel="noopener noreferrer" href={TabOne[tab1].link.ios ? `${TabOne[tab1].link.ios}`:`#`} style={{marginTop:'7px', marginRight:'5px', textAlign: 'center', padding: '5px', display: 'revert' }} className="rn-button-style--2 btn-solid" id="mc-embedded-subscribe">iOS</a>, <a target="_blank" rel="noopener noreferrer" href={TabOne[tab1].link.android ? `${TabOne[tab1].link.android}`:`#`} style={{marginTop:'7px', marginRight:'5px', textAlign: 'center', padding: '5px', display: 'revert' }} className="rn-button-style--2 btn-solid" id="mc-embedded-subscribe">Android</a> ,<a target="_blank" rel="noopener noreferrer" href={TabOne[tab1].code ? `${TabOne[tab1].code}`: `#`} style={{marginTop:'7px', marginRight:'5px', textAlign: 'center', padding: '5px', display: 'revert' }} className="rn-button-style--2 btn-solid" id="mc-embedded-subscribe">{TabOne[tab1].code ? null:`Private`} CodeBase</a>]:[<a target="_blank" rel="noopener noreferrer" href={TabOne[tab1].link ? `${TabOne[tab1].link}`:`#`} style={{marginTop:'7px', marginRight:'5px', textAlign: 'center', padding: '5px', display: 'revert' }} className="rn-button-style--2 btn-solid" id="mc-embedded-subscribe">Visit</a>, <a target="_blank" rel="noopener noreferrer" href={TabOne[tab1].code ? `${TabOne[tab1].code}`: `#`} style={{marginTop:'7px', marginRight:'5px', textAlign: 'center', padding: '5px', display: 'revert' }} className="rn-button-style--2 btn-solid" id="mc-embedded-subscribe">{TabOne[tab1].code ? null:`Private`} CodeBase</a>]}
                                        />
                                    )}
