...
var styles = {"calendar":"styles_calendar__1s6ps","block":"styles_block__1oBAV","footer":"styles_footer__56qQv","loadingAnimation":"styles_loadingAnimation__1DJJ8"};
...
function groupByWeeks(days, weekStart = 0 // 0 = Sunday
  ...
  const firstCalendarDate = getDay__default['default'](firstDate) === weekStart ? firstDate : subWeeks__default['default'](nextDay__default['default'](firstDate, weekStart), 1); // In order to correctly group contributions by week it is necessary to left pad the list,
...
function createCalendarTheme(baseColor, emptyColor = color__default['default']('white').darken(8).toHslString()) {
...
const ActivityCalendar = ({
  ...
  const year = getYear__default['default'](parseISO__default['default']((_data$ = data[0]) === null || _data$ === void 0 ? void 0 : _data$.date));
  ...
  function renderLabels() {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, showWeekdayLabels && /*#__PURE__*/React__default['default'].createElement("g", {
      ...
      const dayIndex = getDay__default['default'](parseISO__default['default'](day.date));
  ...
  function renderFooter() {
    ...
    }, (_labels$legend$less = labels === null || labels === void 0 ? void 0 : (_labels$legend = labels.legend) === null || _labels$legend === void 0 ? void 0 : _labels$legend.less) !== null && _labels$legend$less !== void 0 ? _labels$legend$less : 'Less'), Array(5).fill(undefined).map((_, index) => /*#__PURE__*/React__default['default'].createElement("svg", {
      width: blockSize,
      height: blockSize,
      key: index,
      style: {
